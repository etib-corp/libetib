...
void test_3d(void)
{
    ...
    std::array<std::uint32_t, 2> axis0 = {0, GLFW_JOYSTICK_1};
    std::array<std::uint32_t, 2> axis1 = {0, GLFW_JOYSTICK_2};
    std::array<std::uint32_t, 2> axis2 = {1, GLFW_JOYSTICK_1};
    std::array<std::uint32_t, 2> axis3 = {1, GLFW_JOYSTICK_2};
